...
public class MasjidAdapter extends FirebaseRecyclerAdapter<Masjid, MasjidAdapter.MasjidViewHolder> {

    public MasjidAdapter(@NonNull FirebaseRecyclerOptions<Masjid> options) {
        super(options);
    }
